"""Core NeMo Relay adapter for Atlas tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Atlas tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Atlas Relay tool execution cannot run on an active event-loop thread"
    )
