...
class CodexAppServerSession:
    ...
    def _decide_exec_approval(self, params: dict) -> str:
        ...
        This is protocol-level routing only — it carries NO Atlas
        approval-mode/timeout logic. The Atlas-side resolution happens
    ...
    def _decide_apply_patch_approval(self, params: dict) -> str:
        ...
        Protocol-level routing only; Atlas approval-mode/timeout
...
def _approval_choice_to_codex_decision(choice: str) -> str:
    ...
    NOT in tools/approval.py: the Atlas approval mode/timeout resolution
