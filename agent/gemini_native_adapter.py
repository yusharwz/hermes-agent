        ...
        with httpx.Client(timeout=timeout) as client:
            resp = client.post(
                ...
                headers={
                    ...
                    "X-Goog-Api-Client": f"atlas-agent/{_ATLAS_VERSION}",
                },
            )
...
_FREE_TIER_GUIDANCE = (
    ...
    "for Gemini Flash models). Atlas typically makes 3-10 API calls per user turn, "
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.atlas/.env and restart your session. "
...
class GeminiNativeClient:
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": f"atlas-agent/{_ATLAS_VERSION} (gemini-native)",
            "X-Goog-Api-Client": f"atlas-agent/{_ATLAS_VERSION}",
        }
