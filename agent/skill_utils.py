...
# Org mirrors live under ~/.atlas/skills/_org/<org_id>/. Resolution is
...
def normalize_skill_lookup_name(identifier: str) -> str:
    ...
    under ``~/.atlas/skills/`` (including via symlinks) or configured
    ...
    # ~/.atlas/skills/<name> where <name> is a symlink to a checked-out
