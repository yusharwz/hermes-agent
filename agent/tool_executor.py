...
def _ensure_file_checkpoint(
    ...
    # which can differ from the Atlas process cwd (notably in Docker).  Resolve
...
def _run_agent_tool_execution_middleware(
    ...
    *,
    ...
    """Run Relay rewrites before Atlas policy and dispatch exactly once."""
    ...
    def _atlas_pipeline(relay_args: dict[str, Any]) -> Any:
