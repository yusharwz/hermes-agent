...
def get_provider_env(name: str) -> str:
    ...
    Resolves *name* via :func:`atlas_cli.config.get_env_value` (checks
    ``os.environ`` first, then ``~/.atlas/.env``) so credentials set
    through Atlas' config layer are visible even when they were never
