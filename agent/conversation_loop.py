...
def _apply_active_turn_redirect(agent: Any, messages: List[Dict[str, Any]], text: str) -> None:
    ...
    mechanism as the ~/.atlas/prefill.json incident, 20/20 blocked with
...
def _stored_prompt_matches_runtime(agent, prompt: str) -> bool:
    ...
    def host_info_value(label: str) -> str:
        ...
        occurrence, so only Atlas' own emitted block can satisfy the read.
        """
        prefix = f"{label}:"
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from atlas_cli.lifecycle import (
                        has_hook,
                ...
                if is_context_length_error:
                    ...
                    if available_out is not None:
                        ...
                        # Atlas may add API-only content not present in persisted
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                # timeout (ATLAS_AGENT_TIMEOUT, default 1800s) and the
                ...
                try:
                    ...
                    from atlas_cli.lifecycle import has_hook
                    from atlas_cli.plugins import get_pre_verify_continue_message
