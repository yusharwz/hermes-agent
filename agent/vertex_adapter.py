"""Vertex AI (Google Cloud) adapter for Atlas Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Atlas to use Gemini models via Google Cloud with
...
# who installed plain `atlas-agent` and only later selected a Gemini model.
try:
