...
an 8-column × 9-row atlas; older Atlas/petdex sheets used an 8-row atlas.
Atlas infers the row taxonomy from the sheet and maps agent activity onto
...
- :mod:`agent.pet.store`     — install / list / resolve pets on disk
                               (profile-aware via ``get_atlas_home()``).
