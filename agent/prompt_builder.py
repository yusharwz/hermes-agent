...
DEFAULT_AGENT_IDENTITY = (
    "You are Atlas, a highly capable personal assistant with broad expertise. "
...
ATLAS_AGENT_HELP_GUIDANCE = (
    "When the user needs help with this agent framework itself — configuring, "
    ...
    "`atlas-agent` skill with skill_view(name='atlas-agent') for additional "
...
def computer_use_guidance(platform_name: Optional[str] = None) -> str:
    ...
    return (
        ...
        "when Atlas has none; explicit Atlas YOLO uses a private unrestricted "
...
PLATFORM_HINTS = {
    ...
    "desktop": (
        "You are chatting inside the Atlas desktop app — a graphical chat "
...
def _current_session_platform_hint() -> str:
    ...
    platform = os.environ.get("ATLAS_PLATFORM") or os.environ.get("ATLAS_SESSION_PLATFORM")
    if platform:
        return platform
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot this agent framework itself — its CLI, config, models, providers, tools, "
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: atlas setup, atlas setup tools, atlas setup terminal, atlas status.",
        ]
    )
    return "\n".join(lines)
...
def build_context_files_prompt(
    ...
    # Never let a FALLBACK-picked directory inside the Atlas install/source
    ...
    # explicitly configured cwd is honored verbatim — the Atlas tree is a
    ...
    # their launch dir IS the user's shell cwd (developing Atlas in-tree).
    ...
    if (
        ...
        logger.warning(
            ...
            "fell back to the Atlas install tree (%s) — set terminal.cwd to "
