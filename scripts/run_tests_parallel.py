...
# Set to 0 to disable (env: ATLAS_TEST_FILE_RETRIES).
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=int(
            os.environ.get("ATLAS_TEST_FILE_RETRIES", _DEFAULT_FILE_RETRIES)
        ),
        help=(
            ...
            f"Default: {_DEFAULT_FILE_RETRIES}, env: ATLAS_TEST_FILE_RETRIES."
        ),
    )
    parser.add_argument(
        "--slice",
