...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@atlas.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.atlas": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level ATLAS_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (atlas journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "teknium@dritech.co.id": "teknium1",
    ...
    "shannon@dritech.co.id": "shannonsands",
    ...
    "atlas@dritech.co.id": "NousResearch",
    ...
    "emozilla@dritech.co.id": "emozilla",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on atlas mcp add)
    ...
    "clement@dritech.co.id": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "annguyen@dritech.co.id": "annguyenNous",  # PR #52844 co-author
    ...
    "zhchl@atlas-agent.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "atlas@dritech.co.id"}
...
def main():
    ...
    print(f"{'='*60}")
    print("  Atlas Agent Release Preview")
    print(f"{'='*60}")
