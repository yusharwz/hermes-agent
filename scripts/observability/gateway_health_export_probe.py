...
def main() -> None:
    ...
    atlas_home = Path(tempfile.mkdtemp(prefix="atlas-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "atlas-gateway-smoke",
    ...
    print(json.dumps({"atlas_home": str(atlas_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
