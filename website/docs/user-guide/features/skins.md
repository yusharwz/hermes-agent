...
|------|-------------|----------------|------------------|
| `default` | Classic Atlas — gold and kawaii | `Atlas Agent` | Warm gold borders, cornsilk text, kawaii faces in spinners. The familiar emblem banner. Clean and inviting. |
...
|-----|-------------|--------------------------|
| `banner_border` | Panel border around the startup banner | `#1A94B8` (bronze) |
| `banner_title` | Title text color in the banner | `#2FBFDE` (gold) |
| `banner_accent` | Section headers in the banner (Available Tools, etc.) | `#FFBF00` (amber) |
| `banner_dim` | Muted text in the banner (separators, secondary labels) | `#14788F` (dark goldenrod) |
...
| `ui_label` | UI labels and tags | `#29A6C2` (goldenrod) |
...
| `input_rule` | Horizontal rule above the input area | `#1A94B8` |
| `response_border` | Border around the agent's response box (ANSI escape) | `#2FBFDE` |
| `session_label` | Session label color | `#29A6C2` |
...
| `banner_hero` | string | Rich-markup hero art (replaces the default emblem art) | `""` |
