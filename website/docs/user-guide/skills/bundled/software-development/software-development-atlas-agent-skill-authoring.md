---
title: "Atlas Agent Skill Authoring — Author in-repo SKILL.md files: frontmatter and structure"
...
3. **Description too generic or trigger buried past char 57.** The system prompt
   ...
   - Good: `Use when debugging Atlas skill discovery failures.`
   - Bad: `This skill contains detailed guidance for agents working on Atlas skill discovery failures.`
