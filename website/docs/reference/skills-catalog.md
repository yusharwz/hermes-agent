...
| [`atlas-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-atlas-agent) | Use, configure, theme, extend, and orchestrate Atlas Agent. | `autonomous-ai-agents/atlas-agent` |
...
| [`atlas-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-atlas-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/atlas-agent-skill-authoring` |
| [`inspecting-atlas-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-atlas-desktop-dom) | Read the live Atlas desktop DOM/CSS over CDP. | `software-development/inspecting-atlas-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .atlas/plans/; no execution. | `software-development/plan` |
