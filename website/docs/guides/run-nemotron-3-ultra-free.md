...
[Download the Atlas Desktop installer](https://hermes-agent.nousresearch.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize Atlas. The app connects automatically.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `atlas portal info` confirms you're logged in and routing through Nous.
...
- **[Run Atlas Agent with Nous Portal](/guides/run-atlas-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
