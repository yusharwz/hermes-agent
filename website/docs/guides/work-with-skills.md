...
For how to ship skills in your own plugin, see [Build a Atlas Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
atlas config get skills.config --json
```
