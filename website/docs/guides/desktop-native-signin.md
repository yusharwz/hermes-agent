...
description: "How the Atlas Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Atlas Desktop app connects to a **gated gateway** (a hosted or
...
For Atlas specifically, native sign-in means:
...
- [Run Atlas with Nous Portal](./run-atlas-with-nous-portal.md)
