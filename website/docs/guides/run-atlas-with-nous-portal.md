...
These rows appear in `atlas tools` even before you've logged into Nous Portal — if you pick "Nous Subscription" without an active session, Atlas runs the Portal login inline (without changing your inference provider or your other tools).
