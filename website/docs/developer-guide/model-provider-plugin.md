...
See [Building a Atlas Plugin](/developer-guide/plugins#distribute-via-pip) for the full entry-points setup.
...
- [Building a Atlas Plugin](/developer-guide/plugins) — general plugin authoring
