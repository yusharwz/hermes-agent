...
const PTY_ATTACH_TOKEN_KEY = "atlas.pty.token.chat";
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    //      payloads upload to ATLAS_HOME/images then drive `/image`.
    //
    ...
    // must upload browser bytes to ATLAS_HOME/images, then drive `/image`
