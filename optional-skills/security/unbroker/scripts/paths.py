...
All per-subject data lives under PDD_DATA_DIR (default: $ATLAS_HOME/unbroker),
which is the same trust boundary Atlas uses for .env and OAuth tokens.
"""
...
def data_dir() -> Path:
    ...
    return Path(override) if override else atlas_home() / "unbroker"
