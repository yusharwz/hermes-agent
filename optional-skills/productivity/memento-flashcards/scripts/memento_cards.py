...
Data file: $ATLAS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ATLAS_HOME = Path(os.environ.get("ATLAS_HOME", Path.home() / ".atlas"))
DATA_DIR = _ATLAS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
