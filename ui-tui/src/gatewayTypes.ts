import type { BillingBlock, UsageModelData } from '@atlas/shared/billing'
import type { AtlasSkin } from '@atlas/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@atlas/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = AtlasSkin
...
// Wire shapes now live in @atlas/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
