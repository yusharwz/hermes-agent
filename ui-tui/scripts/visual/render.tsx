 ...
 * across theme x background scenes to <tmpdir>/atlas-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@atlas/ink'
...
// The regenerated slate light_colors block from atlas_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/atlas-agent',
...
const setup = (bgHex: string) => {
  process.env.ATLAS_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
