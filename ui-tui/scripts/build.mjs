...
await build({
  ...
  // Skip the prebuilt @atlas/ink bundle and inline the source instead:
  ...
  alias: { '@atlas/ink': resolve(root, 'packages/atlas-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The atlas_cli launcher
