...
Registry of record: `atlas_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Atlas config+state snapshots (CLI)
