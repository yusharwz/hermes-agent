/**
 * Atlas desktop plugin template. Save as:
 *   <atlas home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <atlas home> is ~/.atlas by default, or ~/.atlas/profiles/<name>
 * when running a named profile (`atlas -p <name>`). Run `atlas doctor` (or
 ...
 * Only these imports resolve: @atlas/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@atlas/plugin-sdk'
