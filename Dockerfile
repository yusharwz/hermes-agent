...
# 'Atlas WebUI' catalog, NAS compose projects that preserve an old
...
#
# The [otlp] extra contains the SDK/exporter imported by Atlas when Gateway
# Health export is enabled. Collector and observability-backend dependencies
# remain external and are not part of the Atlas production image.
#
