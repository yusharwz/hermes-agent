...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Atlas session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Atlas session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Atlas agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Atlas Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Atlas gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Atlas session in it",
