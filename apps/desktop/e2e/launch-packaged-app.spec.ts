...
/**
 * E2E smoke tests for the packaged Atlas desktop app.
 *
 ...
 * (credential stripping, isolated ATLAS_HOME + userData, unique app name).
 *
...
test('window opens with the Atlas title', async () => {
