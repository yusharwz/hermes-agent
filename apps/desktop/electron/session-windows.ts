...
// by main.ts (`setBackgroundThrottling` driven by the merged `atlas:active-work`
...
// (the "Atlas idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Atlas" wake word has NO preceding click,
