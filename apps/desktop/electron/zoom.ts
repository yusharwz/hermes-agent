...
export const ZOOM_STORAGE_KEY = 'atlas:desktop:zoomLevel'
 ...
 * but forgot to emit 'atlas:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('atlas:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
