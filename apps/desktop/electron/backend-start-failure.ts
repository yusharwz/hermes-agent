 ...
 * startAtlas() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startAtlas() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startAtlas`, re-emits
