...
const STORAGE_KEY = 'atlas.desktop.layoutTree.v2'

writeKey('atlas.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('atlas.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('atlas.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'atlas.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'atlas.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ATLAS_LAYOUT_TREE__ = {
    close: closeTreePane,
