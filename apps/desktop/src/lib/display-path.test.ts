...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/atlas-agent')).toBe('~/www/atlas-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/atlas-agent')).toBe('atlas-agent')
    expect(pathLeaf('~/www/atlas-agent')).toBe('atlas-agent')
