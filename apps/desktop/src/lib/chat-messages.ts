...
import { type BillingBlock, skillInvocationText } from '@atlas/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/atlas'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @atlas/shared BillingBlock).
