...
const POPOUT_STORAGE_KEY = 'atlas.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'atlas.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'atlas.desktop.composerPopout.position'
