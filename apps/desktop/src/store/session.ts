import type { ConnectionState } from '@atlas/shared'
...
const COMPOSER_MODEL_SOURCE_KEY = 'atlas.desktop.composer.model-source'
...
const LAST_ROUTE_KEY = 'atlas.desktop.lastRoute'
...
// until config loads, and re-seeded on every profile switch by useAtlasConfig.
