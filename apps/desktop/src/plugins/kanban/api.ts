...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@atlas/plugin-sdk'
...
/** First-class Atlas projects, for scoping a board's default workspace. */
