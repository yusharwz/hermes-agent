 ...
 * `<atlas home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'atlas.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'atlas.desktop.disabledPlugins.v1'
