...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Atlas can react to yours.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Atlas.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Atlas backend elsewhere. Per-profile overrides below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Atlas backend.',
      ...
      cloudDesc: 'Sign in once to Atlas Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Atlas Cloud',
      cloudSignIn: 'Sign in to Atlas Cloud',
      cloudSignedIn: 'Signed in to Atlas Cloud',
      cloudNeedsSignIn: 'Sign in to Atlas Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Atlas Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Atlas Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Atlas Cloud',
      cloudSignedOutMessage: 'Cleared the Atlas Cloud session.',
      ...
      restartingMessage: 'Atlas Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Atlas is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshAtlasPathTitle: 'Atlas path (optional)',
      sshAtlasPathDesc: 'Full path to the remote atlas binary. Blank = auto-detect.',
      sshAtlasPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Atlas found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Atlas runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Atlas is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Atlas path.',
      sshErrPlatform:
        'Unsupported remote platform. Atlas Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Atlas on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Atlas at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up Atlas Desktop',
    setupChoiceDesc:
      'Connect this app to a Atlas gateway you already run, or install Atlas locally on this computer.',
    connectExistingTitle: 'Connect to existing Atlas',
    ...
    installLocalTitle: 'Install Atlas locally',
    installLocalDesc: 'Download Atlas, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Atlas Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Atlas',
    remoteSetupDesc: 'Enter your gateway URL. Atlas Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Atlas gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/atlas',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Atlas gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
