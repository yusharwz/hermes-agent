 ...
 * plugins resolve `@atlas/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ATLAS_PLUGIN_SDK__: sdk,
  __ATLAS_REACT__: React,
  __ATLAS_REACT_JSX__: jsxRuntime,
  __ATLAS_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@atlas/plugin-sdk': shimUrl('__ATLAS_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ATLAS_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ATLAS_REACT_JSX__'),
    react: shimUrl('__ATLAS_REACT__')
  }
