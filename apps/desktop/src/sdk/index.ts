/**
 * @atlas/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__ATLAS_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/atlas'
...
export type { RpcEvent, StatusResponse } from '@/types/atlas'
