...
import type { ConfigFieldSchema, AtlasConfigRecord, ToolsetInfo } from '@/types/atlas'
...
function commandProviderNames(config: AtlasConfigRecord, section: 'tts' | 'stt'): string[] {
