...
const TAKEOVER_KEY = 'atlas.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Atlas can't clear via the API — the user
 *  sees exactly what runs instead of Atlas silently deleting their creds. */
