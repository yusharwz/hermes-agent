...
export function buildReviewFlatList(files: AtlasReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AtlasReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
