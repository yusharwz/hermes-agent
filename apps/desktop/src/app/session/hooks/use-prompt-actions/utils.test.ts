...
describe('renderRpcResult', () => {
  ...
  describe('session.save', () => {
    it('echoes the saved file path', () => {
      expect(renderRpcResult({ file: '/home/user/.atlas/sessions/saved/x.json' }, 'save')).toBe(
        'Saved transcript to /home/user/.atlas/sessions/saved/x.json'
      )
    })
  })
