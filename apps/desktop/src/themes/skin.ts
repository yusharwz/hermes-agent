/**
 * Atlas skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ATLAS_HOME/skins/` (or a
 * built-in) resolved by `atlas_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Atlas authors from a prompt lights up all three surfaces from one file.
 *
...
import type { AtlasSkin, SkinColors } from '@atlas/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: AtlasSkin): DesktopTheme | null {
