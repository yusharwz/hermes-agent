...
def _ensure_sdk_installed() -> bool:
    ...
    # data-volume target instead of writing to /opt/atlas (NS-605).
    ...
    if not is_local:
        ...
        if use_device:
            ...
            try:
                ...
                print("\n  Cancelled. Re-run 'atlas honcho setup' to try again.\n")
                return
            except (AuthorizationTimeout, DeviceCodeExpired):
                print("\n  Device code expired before approval.")
                print("  Re-run 'atlas honcho setup' to get a new code.\n")
                return
            except AccessDenied:
                ...
                return
            print(" approved")
            _apply_grant_to_host(atlas_host, cred)
...
def _headless() -> tuple[bool, bool]:
    """(is_remote, can_open_browser) — degrades safely if atlas_cli internals move."""
    try:
...
def _apply_grant_to_host(atlas_host: dict, cred) -> None:
