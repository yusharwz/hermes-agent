# Atlas Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.atlas/plugins/atlas-achievements/state.json` (existing unlock state)
  - `~/.atlas/plugins/atlas-achievements/scan_snapshot.json` (new)
  - `~/.atlas/plugins/atlas-achievements/scan_checkpoint.json` (new)
