# Atlas Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.atlas/plugins/atlas-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.atlas/plugins/atlas-achievements/scan_checkpoint.json`.
