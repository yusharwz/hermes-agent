...
# Writable sidecar runtime dir (mirrors to ATLAS_HOME on immutable
...
# wiring imports this module for `atlas --help`).
...
# when called later (gateway start, atlas status). Cleared on success.
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    # 3. Provision Spectrum credentials (runtime -> ~/.atlas/.env,
    ...
    try:
        from atlas_cli.config import write_platform_config_field
