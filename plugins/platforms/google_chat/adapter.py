...
def card_spec_to_cards_v2(card_spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {"cardId": str(card_spec.get("card_id") or "atlas-card"), "card": card}
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `atlas setup` to install Google Chat support.",
