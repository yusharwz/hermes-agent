...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def send_exec_approval(
        ...
        actions = [ExecuteAction(
            title="Allow Once", verb="atlas_approve",
            data={**btn_data_base, "atlas_action": "approve_once"}, style="positive",
        )]
        if not smart_denied and allow_session:
            actions.append(ExecuteAction(
                title="Allow Session", verb="atlas_approve",
                data={**btn_data_base, "atlas_action": "approve_session"},
            ))
            if allow_permanent:
                actions.append(ExecuteAction(
                    title="Always Allow", verb="atlas_approve",
                    data={**btn_data_base, "atlas_action": "approve_always"},
                ))
        actions.append(ExecuteAction(
            title="Deny", verb="atlas_approve",
            data={**btn_data_base, "atlas_action": "deny"}, style="destructive",
        ))
        body = [
