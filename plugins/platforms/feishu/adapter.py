...
from atlas_constants import DEFAULT_FEISHU_WEBHOOK_PORT, get_atlas_home
...
_DEFAULT_WEBHOOK_PORT = DEFAULT_FEISHU_WEBHOOK_PORT
...
async def _standalone_send(
    ...
    *,
    ...
    """
    if not FEISHU_AVAILABLE:
        return {"error": "Feishu dependencies not installed. Run `atlas setup` to install Feishu support."}
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `atlas setup` to install Feishu support.",
