...
(function () {
  ...
  function BoardColumns(props) {
    ...
    const isPanBlockedTarget = useCallback(function (target) {
      ...
      if (target.closest && target.closest(".atlas-kanban-card")) return true;
      if (target.closest && target.closest(".atlas-kanban-column-add")) return true;
      if (target.closest && target.closest(".atlas-kanban-col-check")) return true;
    ...
    const stopPan = useCallback(function () {
      ...
      if (el) {
        ...
        el.classList.remove("atlas-kanban-columns--panning");
        el.style.userSelect = "";
      }
    ...
    const handleMouseDown = useCallback(function (e) {
      ...
      setIsPanning(true);
      el.classList.add("atlas-kanban-columns--panning");
    ...
    return h("div", {
      ref: columnsRef,
      className: cn(
        "atlas-kanban-columns",
        isScrollable ? "atlas-kanban-columns--scrollable" : "",
        isPanning ? "atlas-kanban-columns--panning" : "",
      ),
      onDragStart: handleDragStart,
      onDragEnd: handleDragEnd,
  ...
  // centered modal reusing the atlas-kanban-dialog chrome so the form is
  ...
  function InlineCreate(props) {
    ...
    return h("div", {
      ...
      h("form", {
        className: "atlas-kanban-dialog atlas-kanban-create-dialog",
  ...
  function TaskDrawer(props) {
    ...
    return h("div", { className: "atlas-kanban-drawer-shade", onClick: props.onClose },
      h("div", {
        ...
        data ? h("div", { className: "atlas-kanban-drawer-comment-foot" },
          h("div", {
            className: "atlas-kanban-comment-hint text-xs text-muted-foreground",
          ...
          h("div", { className: "atlas-kanban-drawer-comment-row" },
            h(Input, {
              value: newComment,
    ...
    return h("div", { className: "atlas-kanban-drawer-body" },
      ...
      (function () {
        ...
        if (finalResult) {
          ...
          return h("div", { className: "atlas-kanban-section" },
            h("div", { className: "atlas-kanban-section-head" }, label),
        ...
        if (isDone && isParent) {
          return h("div", { className: "atlas-kanban-section" },
            ...
            h("div", { className: "atlas-kanban-done-no-result atlas-kanban-done-parent-note" },
        ...
        if (isDone) {
          return h("div", { className: "atlas-kanban-section" },
            h("div", { className: "atlas-kanban-section-head" }, tx(i18n, "result", "Result")),
            h("div", { className: "atlas-kanban-done-no-result" },
      ...
      childResults.length > 0 ? h("div", { className: "atlas-kanban-section" },
        h("div", { className: "atlas-kanban-section-head" },
        ...
        childResults.map(function (child) {
          ...
          return h("div", { key: child.id, className: "atlas-kanban-comment" },
            h("div", { className: "atlas-kanban-comment-head" },
              h("span", { className: "atlas-kanban-comment-author" },
                `${child.id} · ${child.title || tx(i18n, "untitled", "(untitled)")}`),
              h(Badge, { variant: "outline" }, child.status),
              h("button", {
                type: "button",
                className: "atlas-kanban-diag-action-btn",
  ...
  function ModelEditor(props) {
    ...
    if (!editing) {
      return h("div", { className: "atlas-kanban-meta-row" },
        h("span", { className: "atlas-kanban-meta-label" }, tx(t, "model", "Model")),
        h("span", {
          className: cn(
            "atlas-kanban-meta-value atlas-kanban-editable",
    ...
    return h("div", { className: "atlas-kanban-meta-row" },
      h("span", { className: "atlas-kanban-meta-label" }, tx(t, "model", "Model")),
      loading
        ? h("span", { className: "atlas-kanban-meta-value text-muted-foreground" },
