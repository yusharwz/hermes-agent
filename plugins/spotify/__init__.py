...
``_check_spotify_available()`` — when the user has not run ``atlas auth
spotify``, the tools remain registered (so they appear in ``atlas
...
The Spotify auth flow (``atlas auth spotify``), CLI plumbing, and docs
