...
# When the user hasn't picked a reasoning effort, Atlas passes
...
# ON at this effort — matching the "medium (default)" that Atlas' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Atlas' effort vocabulary onto Solar's accepted set. xhigh/max/
