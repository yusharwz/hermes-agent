...
@pytest.fixture()
def server(atlas_home, monkeypatch):
    ...
    # Pin config resolution to the isolated ATLAS_HOME. Sibling test
    ...
    # module-level ``_atlas_home = get_atlas_home()`` snapshot freezes
    ...
    monkeypatch.setattr(mod, "_atlas_home", atlas_home)
