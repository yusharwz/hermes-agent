...
The workers carry ``atlas_cli.ninegate_update`` in argv deliberately. The
...
from atlas_cli import ninegate_update as nu
...
def test_only_one_process_may_claim_the_install_tree(tmp_path):
    ...
    procs = [
        subprocess.Popen(
            ...
            [sys.executable, "-c", code, "atlas_cli.ninegate_update", str(fifo)],
