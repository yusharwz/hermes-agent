...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (atlas_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_atlas_overlays():
    """atlas_cli.providers.get_provider("vertex") backs
