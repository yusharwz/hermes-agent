...
from atlas_cli.auth import PROVIDER_REGISTRY as _REGISTRY
...
_EXTRA_ENV_VARS = (
    ...
    "ATLAS_COPILOT_ACP_COMMAND", "COPILOT_CLI_PATH",
...
class TestFetchDeepInfraModels:
    ...
    def test_returns_filtered_models_on_success(self, monkeypatch):
        ...
        import atlas_cli.models as models
        monkeypatch.setattr(
            models, "_urlopen_model_catalog_request", lambda *a, **kw: _Resp()
        )
        from atlas_cli.models import _fetch_deepinfra_models
...
class TestDeepInfraProviderProfile:
    ...
    def test_profile_registered_with_alias_and_aux(self):
        ...
        from atlas_cli.auth import PROVIDER_REGISTRY, resolve_provider
