...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "_is_default_atlas_home", lambda home: False)
    ...
    assert str(atlas_home) in output
