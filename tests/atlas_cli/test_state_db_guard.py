...
from atlas_cli.backup import copy_db_and_verify, verify_sqlite_integrity
...
class TestPreUpdateBackupIntegrityGuard:
    ...
    ATLAS_HOME whose state.db is corrupted mid-flight (#68474)."""
    ...
    def test_healthy_db_stays_quiet(self, atlas_home, capsys):
    ...
    def test_zeroed_db_after_snapshot_is_loud(self, atlas_home, capsys, monkeypatch):
