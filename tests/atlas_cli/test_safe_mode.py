"""Tests for `atlas chat --safe-mode` isolation."""
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ATLAS_SAFE_MODE"] == "1"
        assert os.environ["ATLAS_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ATLAS_IGNORE_RULES"] == "1"
        return True
