...
from atlas_cli.main import _read_ssh_session_token_file, cmd_dashboard
...
def test_token_file_rejects_symlink(tmp_path, monkeypatch):
    home = tmp_path / "home"
    token_dir = home / ".atlas" / "desktop-ssh" / ("a" * 32)
    ...
    override = set_atlas_home_override(home / ".atlas")
    try:
        ...
        reset_atlas_home_override(override)
