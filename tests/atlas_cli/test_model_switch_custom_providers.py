...
def _disable_live_custom_provider_model_probe(monkeypatch):
    ...
    monkeypatch.setattr("atlas_cli.models.fetch_api_models", lambda *_a, **_kw: None)
    monkeypatch.setattr(
        "atlas_cli.models.cached_provider_model_ids", lambda *_a, **_kw: []
    )
    monkeypatch.setattr(
        "atlas_cli.models.provider_model_ids", lambda *_a, **_kw: []
    )
...
def test_list_authenticated_providers_includes_custom_providers(monkeypatch):
    ...
    monkeypatch.setattr("atlas_cli.models.fetch_api_models", lambda *a, **k: [])
...
def test_picker_selection_resolves_named_custom_provider_model_id(monkeypatch):
    ...
    monkeypatch.setattr("atlas_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr(
        "atlas_cli.model_switch.get_model_capabilities",
        lambda *a, **k: None,
    )
...
def test_discovered_models_auto_saved_to_cache(monkeypatch):
    ...
    monkeypatch.setattr("atlas_cli.models.fetch_api_models", fake_fetch_api_models)
    monkeypatch.setattr(
        "atlas_cli.model_switch._save_discovered_models_to_config",
...
def test_save_discovered_models_preserves_dict_form(monkeypatch):
    ...
    from atlas_cli.model_switch import _save_discovered_models_to_config
    ...
    monkeypatch.setattr("atlas_cli.config.save_config", fake_save)
    monkeypatch.setattr(
