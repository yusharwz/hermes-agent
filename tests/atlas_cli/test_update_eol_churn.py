"""Regression: ``atlas update`` should take a managed checkout off autocrlf=true.
...
``atlas update`` has to repair them.
...
from atlas_cli.update_cmd import _normalize_managed_eol
