...
from atlas_cli.setup_hidden_env import is_setup_hidden_env
...
class TestChannelCards:
    ...
    def test_no_card_shows_a_hidden_knob(self):
        from atlas_cli.web_server import _messaging_platform_catalog
...
class TestCliWizard:
    """`atlas setup gateway` drops the same knobs. Real wizard, scripted
    stdin, real .env writes under a temp ATLAS_HOME."""
