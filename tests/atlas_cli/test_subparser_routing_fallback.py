...
The main() function in atlas_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `atlas -c model`
...
def _build_parser():
    """Build a minimal replica of the atlas top-level parser."""
