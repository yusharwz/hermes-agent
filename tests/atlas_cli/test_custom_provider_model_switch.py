...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from atlas_cli.main import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("atlas_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("atlas_cli.main._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
