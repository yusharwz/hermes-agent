...
Run: pytest tests/atlas_cli/test_dashboard_auth_native_flow.py
"""
...
from atlas_cli.dashboard_auth import native_flow
from atlas_cli.dashboard_auth.base import Session
...
def _walk_native_login(client, *, redirect_uri, challenge, state="cli-state"):
    ...
    assert "atlas_session_at" not in set_cookie, (
