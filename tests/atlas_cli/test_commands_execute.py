...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`atlas_cli.slash_exec.EXECUTORS`, and
...
from atlas_cli.commands import COMMAND_REGISTRY, resolve_command
from atlas_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
