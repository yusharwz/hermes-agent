"""Tests for `atlas secrets bitwarden token` / `atlas secrets onepassword token`.
...
from atlas_cli import onepassword_secrets_cli as op_cli
from atlas_cli import secrets_cli as bw_cli
