...
class TestFetchOpenRouterModels:
    ...
    def test_falls_back_to_static_snapshot_on_fetch_failure(self, monkeypatch):
        ...
        with patch("atlas_cli.model_catalog.get_curated_openrouter_models", return_value=None), \
             patch("atlas_cli.models._urlopen_model_catalog_request", side_effect=OSError("boom")):
    ...
    def test_filters_out_models_without_tool_support(self, monkeypatch):
        ...
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        with (
            patch("atlas_cli.model_catalog.get_curated_openrouter_models", return_value=[]),
            patch("atlas_cli.models._urlopen_model_catalog_request", return_value=_Resp()),
        ):
            models = fetch_openrouter_models(force_refresh=True)
...
class TestNousRecommendedModels:
    ...
    def test_fetch_caches_per_portal_url(self):
        ...
        with patch("atlas_cli.models._urlopen_model_catalog_request", return_value=mock_cm) as mock_urlopen:
