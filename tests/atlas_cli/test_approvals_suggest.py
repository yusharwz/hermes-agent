"""Tests for ``atlas approvals suggest`` (atlas_cli/approvals_suggest.py).

Approval history in Atlas is implied, not ledgered: the session DB
...
from atlas_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
