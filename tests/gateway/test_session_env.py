...
def test_set_session_env_sets_contextvars(monkeypatch):
    ...
    monkeypatch.delenv("ATLAS_SESSION_CHAT_TYPE", raising=False)
    ...
    assert get_session_env("ATLAS_SESSION_CHAT_TYPE") == "group"
    ...
    assert os.getenv("ATLAS_SESSION_CHAT_TYPE") is None
...
def test_clear_session_env_restores_previous_state(monkeypatch):
    ...
    assert get_session_env("ATLAS_SESSION_CHAT_TYPE") == ""
