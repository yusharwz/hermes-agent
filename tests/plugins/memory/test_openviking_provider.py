...
def test_openviking_provider_config_loader_uses_readonly_config(monkeypatch):
    ...
    config = openviking_module._load_atlas_openviking_config()
...
def test_tool_add_resource_rejects_atlas_credential_file_upload(tmp_path, monkeypatch):
...
def test_concurrent_providers_claim_unlocked_pending_owner_once(
    ...
    for provider in providers:
        ...
        provider._atlas_home = str(tmp_path)
