...
# tests/atlas_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("atlas_cli.lifecycle.invoke_hook")
@patch("atlas_cli.lifecycle.finalize_session")
