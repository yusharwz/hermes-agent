...
def _ensure_terminal_env_bridged() -> None:
    ...
    vars at startup — but processes that skip all of those paths (``atlas
    ...
    be stale from ``atlas setup``). Environment values for omitted terminal
    ...
    try:
        from atlas_cli.config import apply_terminal_config_to_env, read_raw_config
                ...
                if background and (notify_on_complete or watch_patterns):
                    ...
                    if not _async_ok():
                        ...
                        result_data["notify_unsupported"] = (
                            ...
                            "the turn ends (a one-shot runner such as `atlas -z`, a "
