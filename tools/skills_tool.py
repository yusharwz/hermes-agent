...
# Cache validation (mirrors atlas_cli/profiles.py::_count_skills, d5eee133e):
...
def _skills_dir() -> Path:
    ...
    set ATLAS_HOME. Keep the legacy SKILLS_DIR module attribute for tests and
    external patchers, but when it has not been patched, resolve from the live
    profile-scoped ATLAS_HOME on every call.
    """
...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    # (_skills_dir() resolves the LIVE profile ATLAS_HOME; the module-level
            ...
            try:
                ...
                if is_org_mirror_path(skill_dir, active_skills_dir):
                    ...
                    header = (
                        ...
                        "them back with\n"
                        "> `atlas sync propose` (or automatically, if your "
                        "org enables it).\n\n"
                    )
