...
- **Third-party products / other people's projects integrated into the core
  ...
  **standalone plugin repo** users install into `~/.atlas/plugins/` (or via a
  pip entry point), and promote them in the Dritech Discord
...
don't own. Promote standalone plugins in the Dritech Discord
...
subprocess (`--file-retries`, default 1; `ATLAS_TEST_FILE_RETRIES=0` to
