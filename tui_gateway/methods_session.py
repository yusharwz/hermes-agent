...
def _(rid, params: dict) -> dict:
    ...
    from atlas_cli.nous_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from atlas_cli.nous_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from atlas_cli.nous_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    from atlas_cli.nous_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from atlas_cli.nous_billing import BillingError
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        home_token = (
            set_atlas_home_override(parent_home) if parent_home else None
        )
        try:
