...
def _(rid, params: dict) -> dict:
    try:
        from atlas_cli.inventory import build_model_options_payload
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from atlas_cli.inventory import build_models_payload
        ...
        # Save the key to ~/.atlas/.env via the unified credential lifecycle
