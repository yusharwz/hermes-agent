...
Full automation blueprints gallery: [atlas-agent.nousresearch.com/docs/reference/automation-blueprints-catalog](https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog)

Documentation: [atlas-agent.nousresearch.com](https://hermes-agent.nousresearch.com)

GitHub: [github.com/NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)

---

*Atlas Agent is built by [Dritech](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*
