...
class AIAgent:
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        try:
            from atlas_cli import lifecycle as _lifecycle
    ...
    def interrupt(self, message: str = None) -> None:
        ...
        # interrupt event rather than Atlas' per-thread flag.
    ...
    def redirect(self, text: str) -> bool:
        ...
        During a normal Atlas model request this cancels only that request;
    ...
    def close(self) -> None:
        ...
        # a private embedded daemon when Atlas YOLO selected unrestricted
    ...
    def _build_keepalive_http_client(base_url: str = "", *, verify: Any = True) -> Any:
        ...
        ``ATLAS_CA_BUNDLE`` settings.  It is passed on the client AND on
    ...
    def _apply_client_headers_for_base_url(
        ...
        *,
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            self._client_kwargs["default_headers"] = atlas_xai_default_headers()
        else:
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from atlas_cli.models import ollama_model_supports_thinking
    ...
    def run_conversation(
        ...
        from atlas_cli.observability.relay_shared_metrics import (
            finish_task_run,
            start_task_run,
        )
