...
let
  ...
  targetPlatform =
    if stdenv.hostPlatform.isDarwin then
      ...
      throw "atlas-desktop: unsupported host platform for node-pty staging";
  ...
  targetArch =
    if stdenv.hostPlatform.isAarch64 then
      ...
      throw "atlas-desktop: unsupported host arch for node-pty staging";
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    substituteInPlace $out/share/atlas-desktop/dist/electron-main.mjs \
