...
TIPS = [
    ...
    "atlas chat --max-turns 1000 overrides the default 500-iteration limit per turn.",
    ...
    # --- MCP ---
    "atlas mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "atlas mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    ...
    'atlas import restores a full Atlas backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
