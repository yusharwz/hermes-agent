            ...
            if last_error:
                ...
                if "Permission denied" in last_error:
                    print(color(
                        ...
                        "(e.g. rewritten by a root `docker exec atlas "
                        "atlas cron ...`). Fix ownership to match the "
...
def cron_command(args):
    ...
    print("Usage: atlas cron [list|create|edit|pause|resume|run|remove|status|runs|tick]")
    sys.exit(1)
