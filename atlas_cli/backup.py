...
# to the user as a hung `atlas update` (#70553 follow-up). Sessions databases
...
def verify_sqlite_integrity(
    ...
    *,
    ...
    if check_header:
        ...
        # atlas_cli.sqlite_safe_read). Verification targets snapshots and
        ...
        if profiles_dir.is_dir():
            try:
                ...
                if any(profiles_dir.iterdir()):
                    ...
                    print("  Run: atlas profile list  (after installing atlas)")
...
def create_quick_snapshot(
    ...
    if failed_dbs:
        ...
        print(
            ...
            f"{root} and run: atlas snapshot list"
        )
        logger.error(
