"""Relay subscriber for the persisted Atlas shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Atlas counters from Relay lifecycle events."""
    ...
    def __init__(
        ...
        *,
        ...
        self.store = store
        self._atlas_version = atlas_version or "unknown"
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Atlas shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
