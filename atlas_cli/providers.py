...
def determine_api_mode(provider: str, base_url: str = "", model: str = "") -> str:
    ...
    *model* is optional but required for dual-wire providers (Nous) whose
    ...
    # chat_completions. The Atlas overlay still advertises openai_chat
...
def resolve_provider_full(
    ...
    # 0.5 Exact Atlas provider IDs must win over LOSSY alias collapsing.
    ...
    if canonical != raw:
        try:
            from atlas_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
