...
Usage:
    ...
    atlas pairing approve <platform> <request-id|code>  # Approve a pairing request
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: atlas pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'atlas pairing list' to see pending requests.\n")
