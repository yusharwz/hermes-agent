...
def _reauth_oauth_server(name: str, server_config: dict) -> bool:
    ...
    #
    # force_interactive_oauth: `atlas mcp login` is *explicitly* user-
    # initiated even when stdin isn't a TTY (Atlas desktop / agent-
...
def mcp_command(args):
    ...
    if handler:
        ...
        _info("atlas mcp catalog                            List Nous-approved MCPs")
