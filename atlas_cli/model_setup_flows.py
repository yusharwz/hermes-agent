...
def _model_flow_ai_gateway(config, current_model=""):
    ...
    # Route through _prompt_api_key so users can replace a stale/broken key
    # in-flow (K/R/C) instead of having to edit ~/.atlas/.env by hand.
    ...
    from atlas_cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
def _model_flow_bedrock_api_key(config, region, current_model=""):
    ...
    # Check env var and credential pool (keys added via `atlas auth`)
    from atlas_cli.auth import _resolve_api_key_provider_secret, ProviderConfig
