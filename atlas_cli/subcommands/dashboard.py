...
def build_dashboard_parser(
    ...
    # (cmd_dashboard exports ATLAS_SERVE_HEADLESS=1). `dashboard` leaves it
    ...
    # client with Nous Portal and write the client_id into ~/.atlas/.env.
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "ATLAS_DASHBOARD_OAUTH_CLIENT_ID into ~/.atlas/.env, and prints "
            "how to engage the login gate. Requires being logged in (atlas setup)."
        ),
    )
    ...
    dashboard_register_parser.add_argument(
        ...
        help=(
            ...
            "portal. Also settable via ATLAS_DASHBOARD_PORTAL_URL. Mainly for "
